...
<body>
      ...
      <div class="slider_container">
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-5 ">
                    <div class="img-box">
                      <img src="{{url::to('/')}}/public/images/slider-img.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="carousel_btn-box">
            ...
            <img src="{{url::to('/')}}/public/images/line.png" alt="" />
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p1.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Ring
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p2.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Watch
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p3.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Teddy Bear
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p4.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Flower Bouquet
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p5.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Teddy Bear
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p6.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Flower Bouquet
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p7.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Watch
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/p8.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Ring
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="{{url::to('/')}}/public/images/saving-img.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="{{url::to('/')}}/public/images/gifts.png" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-7">
  ...
  <script src="{{url::to('/')}}/public/js/jquery-3.4.1.min.js"></script>
  <script src="{{url::to('/')}}/public/js/bootstrap.js"></script>
